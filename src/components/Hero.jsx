...
export default function Hero() {
  ...
  const db = (key) => lang !== 'ar' && content[key]
  ...
  const heroTitle  = db('hero_title')
  const heroSub    = db('hero_subtitle') || h.subtitle
