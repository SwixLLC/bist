    ...
    <>
      ...
      `}>
        <div className="px-5 py-5 border-b border-navy-800 flex items-center gap-3">
          <a href="https://bist.ma" target="_blank" rel="noopener noreferrer">
            <img src={`${import.meta.env.BASE_URL}icon.webp`} alt="Badrane" className="h-9 w-auto hover:opacity-80 transition-opacity" />
          </a>
